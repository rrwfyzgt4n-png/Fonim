...
struct VibeVoiceBatchCoreChecks {
    ...
    private static func checkPostRefactorUXPolish() throws {
        ...
        precondition(generationWorkspace.contains("SessionDetailView(record: session, showsNavigationTitle: false)"))
        precondition(generationWorkspace.contains(".allowsHitTesting(false)"))
        ...
        precondition(sessionDetail.contains("var showsNavigationTitle = true"))
        precondition(sessionDetail.contains("if showsNavigationTitle"))
